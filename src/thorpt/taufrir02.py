...
if __name__ == '__main__':
    ...
    compPlot.pt_path_plot(rock_tag='rock0', img_save=True, gif_save=True)
    compPlot.permeability_plot(rock_tag='rock0', img_save=True, gif_save=True)
    compPlot.time_int_flux_plot(rock_tag='rock0', img_save=True, gif_save=True)
    compPlot.porosity_plot(rock_tag='rock0', img_save=True, gif_save=True)
    compPlot.release_fluid_volume_plot(rock_tag='rock0', img_save=True, gif_save=True)
    print()
